...
\newcommand{\vepsfine}{\veps_{\texttt{fine}}}
\newcommand{\vepscoarse}{\veps_{\texttt{coarse}}}
\newcommand{\ratecoarse}{\cC_{\texttt{coarse}}(\Pi,N,n)}
\newcommand{\ratefine}{\cC_{\texttt{fine}}(\Pi,n)}

\newcommand{\leqsim}{\approxleq}

\newcommand{\hth}{\widehat{\theta}}
\newcommand{\pos}[1]{\brk*{#1}_+}
\newcommand{\ths}{\theta^\star}
\newcommand{\sigs}{\sigma_\star}
\newcommand{\Varpist}[1]{\Var_{\pistar}(#1)}
\newcommand{\VarpistH}[1]{\widetilde{\Var}_{\pistar}(#1)}
\DeclarePairedDelimiter{\nrmop}{\|}{\|_{\mathrm{op}}}
\newcommand{\Dseq}[2]{D_{\mathsf{seq},N}\prn*{#1\,\|\,#2}}
\newcommand{\yh}[1][h]{y_{1:#1}}

\newcommand{\xyh}[1][h]{x,y_{1:#1}}
\newcommand{\xyhm}{\xyh[h-1]}
\newcommand{\cDmini}{\cD}

\newcommand{\Dxyh}[4][{h-1}]{#2{#3(\cdot\mid\xyh[#1])}{#4(\cdot\mid\xyh[#1])}}
\newcommand{\KLxyh}[3][{h-1}]{\Dkl{#2(\cdot\mid\xyh[#1])}{#3(\cdot\mid\xyh[#1])}}

\newcommand{\pcov}[1][{\N}]{\texttt{Cov}_{#1}}
\newcommand{\Pcov}[1][{\N}]{\texttt{Cov}_{#1}}
\newcommand{\PcovD}[1][{\N}]{\texttt{Cov}^{\pistar}_{#1}}
\newcommand{\Cmp}[1][{\N}]{\smash{\wh{\texttt{Cov}}}_{#1}} %
\newcommand{\Cmpv}[1][{\N}]{\PcovD[#1]} %
\newcommand{\Cmpvv}[2]{\Pcov[#1]^{#2}}


\newcommand{\covinf}{\cN_\infty}
\newcommand{\rhoinf}{\rho_\infty}
\newcommand{\DEgamma}[3][M]{\cE_{#1}\prn*{#2\,\|\,#3}}

\newcommand{\cSM}[1][N]{\cS_{#1}}

\newcommand{\epsapp}{\veps_{\texttt{apx}}}
\newcommand{\vepsapp}{\veps_{\texttt{apx}}}

\newcommand{\Lhat}{\wh{L}_n}
\newcommand{\Lpos}[1][C]{L_{#1}^+}
\newcommand{\Lneg}[1][C]{L_{#1}^-}

\newcommand{\whp}[1][\delta]{with probability at least $1-#1$}
\newcommand{\Whp}[1][\delta]{With probability at least $1-#1$}


\newcommand{\lcov}[1][\veps]{\texttt{LCov}_{#1}}
\newcommand{\Fcov}[1][M]{\texttt{FCov}_{#1}}
\newcommand{\fcov}[1][M]{\texttt{FCov}_{#1}}
\newcommand{\mcov}[1][\veps]{\texttt{MCov}_{#1}}
\newcommand{\ccov}{\texttt{LCov}}

\newcommand{\comp}{\mathrm{c}}

\newcommand{\Df}[2]{D_{f}\prn*{#1\dmid{}#2}}
