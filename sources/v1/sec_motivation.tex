...
\end{align}
suggests an unbiased estimate of $f(x)$. Is it possible to sample from $\Ber(ce^{-f(x)})$ if we have access to an unbiased estimate of $f(x)$? A general version of this question is known as the ``Bernoulli factory'' problem \citep{keane1994bernoulli,nacu2005fast}. For our purposes, this can be stated as the following abstract task:
\begin{center}
